 ...
 */
final class Version20240212111339 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE productos_mascotas (producto_id INT NOT NULL, mascota_id INT NOT NULL, INDEX IDX_584E110D7645698E (producto_id), INDEX IDX_584E110DFB60C59E (mascota_id), PRIMARY KEY(producto_id, mascota_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
